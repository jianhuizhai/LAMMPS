...
print(linecommon)
print("The number of already deleted ions are %i: "  %x_d.size)
...
#=================================================================================
DumpOutput('dump.vacancies',xlim, ylim, zlim, atom_id, atom_type, x, y, z, Eng)
print("Output file: dump.vacancies")